...
class MessageForm(forms.Form):
    ...
    Div(
        ...
        Div(Field('textarea', label="", placeholder="Type in your question"), css_class='span3'),
        Div(Field('textarea', label="", placeholder="Your answer shows here", readonly = 'yes',), css_class='span3', readonly='yes'),
    ),
